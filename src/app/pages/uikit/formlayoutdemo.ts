    ...
    template: `<p-fluid>
        <div class="flex flex-col md:flex-row gap-8">
            <div class="md:w-1/2">
                <div class="card flex flex-col gap-4">
                    <div class="font-bold text-2xl">Vertical</div>
                ...
                <div class="card flex flex-col gap-4">
                    <div class="font-bold text-2xl">Vertical Grid</div>
            ...
            <div class="md:w-1/2">
                <div class="card flex flex-col gap-4">
                    <div class="font-bold text-2xl">Horizontal</div>
                ...
                <div class="card flex flex-col gap-4">
                    <div class="font-bold text-2xl">Inline</div>
                ...
                <div class="card flex flex-col gap-4">
                    <div class="font-bold text-2xl">Help Text</div>
        ...
        <div class="flex mt-8">
            <div class="card flex flex-col gap-6 w-full">
                <div class="font-bold text-2xl">Advanced</div>

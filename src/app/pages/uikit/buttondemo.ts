    ...
    template: `<div class="flex flex-col md:flex-row gap-8">
        <div class="md:w-1/2">
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Default</div>
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Severities</div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Text</div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Outlined</div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Group</div>
                <div class="flex flex-wrap gap-2">
                    <p-buttongroup>
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">SplitButton</div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Templating</div>
                <div class="flex flex-wrap gap-2">
        ...
        <div class="md:w-1/2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Raised</div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Rounded</div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Rounded Icons</div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Rounded Text</div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Rounded Outlined</div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card flex flex-col gap-4">
                <div class="font-bold text-2xl">Loading</div>
                <div class="flex flex-wrap gap-2">

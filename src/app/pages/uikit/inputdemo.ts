    ...
    template: ` <p-fluid class="flex flex-col md:flex-row gap-8">
            <div class="md:w-1/2">
                <div class="card flex flex-col gap-4">
                    <div class="font-bold text-2xl">InputText</div>
                    ...
                    <div class="font-bold text-2xl">Icons</div>
                    <p-iconfield>
                ...
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="flex flex-row mt-6">
                        ...
                        <div class="flex flex-col gap-4 w-1/2">
                            <div class="font-bold text-2xl">ColorPicker</div>
                            <p-colorpicker [style]="{ width: '2rem' }" [(ngModel)]="colorValue" />
                        </div>
                    </div>

                    <div class="font-bold text-2xl">Knob</div>
                    <p-knob [(ngModel)]="knobValue" [step]="10" [min]="-50" [max]="50" valueTemplate="{value}%" />
                </div>
            </div>
            <div class="md:w-1/2">
                <div class="card flex flex-col gap-4">
                    <div class="font-bold text-2xl">RadioButton</div>
                    <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="font-bold text-2xl">Checkbox</div>
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex items-center">
        ...
        <p-fluid class="flex mt-8">
            <div class="card flex flex-col gap-6 w-full">
                <div class="font-bold text-2xl">InputGroup</div>
